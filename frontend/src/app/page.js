		...
		<ReduxProvider>
			<div className="min-h-screen w-screen text-white">
				<main className="grid grid-cols-12 min-h-screen">
					...
					<section className="hidden md:grid md:col-start-1 md:col-end-4 md:h-screen bg-[#1A1A1A]">
						<SideBar />
					</section>

					{/* Main content area */}
					<section className="grid col-span-full grid-rows-[8%_auto] md:grid-rows-[6%_auto] md:col-start-4 md:col-end-11 bg-[#242424]">
						<TopBar />
						<Graph />
					</section>
